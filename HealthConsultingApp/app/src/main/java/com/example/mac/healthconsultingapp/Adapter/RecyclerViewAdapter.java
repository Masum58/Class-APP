package com.example.mac.healthconsultingapp.Adapter;
...
import com.example.mac.healthconsultingapp.Interface.ItemClickListener;
import com.example.mac.healthconsultingapp.Model.Exercise;
import com.example.mac.healthconsultingapp.R;
import com.example.mac.healthconsultingapp.ViewExercise;
    ...
    public void onBindViewHolder(RecyclerViewHolder holder, int position) {
        ...
        holder.setItemClickListener(new ItemClickListener(){
            ...
            public void onClick(View view, int position){
                //Call New Activity
                Toast.makeText(context,"Starting "+exerciseList.get(position).getName(),Toast.LENGTH_SHORT).show();
